...
- Name: hash.spec.ts >> Hash Generator — E2E >> Hash comparison >> shows no match when hash does not match
- Location: src/e2e/hash.spec.ts:58:9
...
Locator: getByText('No Match')
Expected: visible
Error: strict mode violation: getByText('No Match') resolved to 2 elements:
    1) <span class="flex items-center gap-1.5 text-sm font-bold text-red-400">✗ No Match</span> aka getByText('✗ No Match')
    2) <span class="text-[10px] text-gray-500 ml-1">→ MD5: NO MATCH</span> aka getByText('→ MD5: NO MATCH')

Call log:
  - Expect "toBeVisible" with timeout 5000ms
  - waiting for getByText('No Match')
          ...
          - generic [ref=e114]:
            - generic [ref=e115]:
              - generic [ref=e116]:
                ...
                - textbox "e.g. 5d41402abc4b2a76b9719d911017c592" [ref=e118]: "00000000000000000000000000000000"
              - generic [ref=e119]:
