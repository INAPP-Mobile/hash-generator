...
export const metadata: Metadata = {
  title: "Hash Generator — freeq.one",
  description: "Generate MD5, SHA1, SHA256, SHA512 hashes instantly. Compare text against a hash. Part of the freeq.one tools suite.",
};
